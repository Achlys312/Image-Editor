from tkinter import RIGHT, Frame, Button, LEFT
...
class EditBar(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.converter_button = Button(self, text="Converter")
        ...
        self.converter_button.bind("<ButtonRelease>", self.converter_button_released)
    ...
    def converter_button_released(self, event):
        if self.winfo_containing(event.x_root, event.y_root) == self.converter_button:
            if self.master.is_image_selected:
                if self.master.is_draw_state:
                    self.master.image_viewer.deactivate_draw()
                if self.master.is_crop_state:
