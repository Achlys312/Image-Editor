...
typearea=Text(F2,font='arial 15', yscrollcommand=scroll.set)
...
B2=Button(F3,text='Save',font='arial 20 bold',bg='yellow',fg='red',width=10,command=save)
B2.grid(row=0,column=1,padx=20,pady=10)

B3=Button(F3,text='Print',font='arial 20 bold',bg='yellow',fg='red',width=10,command=print)
B3.grid(row=0,column=2,padx=20,pady=10)

B4=Button(F3,text='Reset',font='arial 20 bold',bg='yellow',fg='red',width=10,command=reset)
B4.grid(row=0,column=3,padx=20,pady=10)

B5=Button(F3,text='Exit',font='arial 20 bold',bg='yellow',fg='red',width=10,command=Exit)
